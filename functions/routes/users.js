...
router.put('/users/:user', async (req, res) => {res.send(await firestore.addUser(req.user, req.body))});
...
router.put('/users/:user/addons/:addon', async (req, res) => {res.send(await firestore.addAddon(req.user, req.addon, req.body))});
...
router.put('/users/:user/addons/:addon/settings', async (req, res) => {res.send(await firestore.updateSettings(req.user, req.addon, req.body))});
...
router.put('/users/:user/tokens/:platform', async (req, res) => {res.send(await firestore.addToken(req.user, req.platform, req.body))});
